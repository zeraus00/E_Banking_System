...
namespace EBankingSystem.Migrations
{
    ...
    [Migration("20250505143400_UnlinkLoanTransactionsToAccounts")]
    partial class UnlinkLoanTransactionsToAccounts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserAuthAccount", b =>
                {
                    b.Property<int>("AccountId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UserAuthAccount", b =>
                {
                    b.HasOne("Data.Models.Finance.Account", null)
                        .WithMany()
                        .HasForeignKey("AccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Data.Models.Authentication.UserAuth", null)
                        .WithMany()
